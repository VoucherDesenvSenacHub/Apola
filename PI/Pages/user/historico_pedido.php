                ...
                <div class="container_historico_pedido">
                    ...
                    <div class="container_body_cart">
                        ...
                        <div class="conatiner_btn_drop">
                            <div id="btnOpenDrop" class="btn_drop"><i class="fa-solid fa-plus"></i></div>
                        </div>
                        <div id="ConteudoDrop" class="container_final_cart">
                            ...
                            <div class="container_final_cart_right">
                                ...
                                <div class="container_text_preco_final_cart">
                                    ...
                                    <p style="font-weight: 500; color: #4A4A4A;"class="total_valor_cart">LX123456789BR</p>
                                </div>
                                <div class="shape_sacola_final"></div>
